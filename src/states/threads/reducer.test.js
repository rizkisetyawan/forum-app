 ...
 *  - should return the threads with the toggled like thread when given by TOGGLE_DISLIKE_THREAD
 *
 */
...
describe('threadReducers function', () => {
  ...
  it('should return the threads with the toggled like thread when given by TOGGLE_DISLIKE_THREAD action', () => {
    // arrange
    const initialState = [
      {
        id: 'thread-1',
